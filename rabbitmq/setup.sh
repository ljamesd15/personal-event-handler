...
mosquitto_pub -h localhost -t weather -m '{"temperature":0,"pressure":0,"humidity":0,"windSpeed":0,"windDirection":"N","luminosity":0,"uvIndex":0,"sensorMetadata":{"longitude":0,"latitude":0,"id":"string","tags":["string"],"location":"string"}}' -q 1 -p 1883 -u "$WEATHER_RABBITMQ_PUBLISHER" -P "$WEATHER_RABBITMQ_PUBLISHER_PASSWORD"
